...
const SocialLinks = () => {
  ...
  return (
    <div className="w-full glass-card border border-slate-200/90 shadow-xl rounded-3xl p-6 sm:p-8 backdrop-blur-xl">
      <h3
      ...
      <div className="flex flex-col gap-4">
        ...
        <a
          ...
          className="group relative flex items-center justify-between p-4 rounded-2xl bg-white border border-slate-200 overflow-hidden hover:border-sky-300 hover:shadow-lg transition-all duration-500"
          data-aos="fade-up"
        >
          <div
            className={`absolute inset-0 opacity-0 group-hover:opacity-10 transition-opacity duration-500 bg-gradient-to-r ${linkedIn.gradient}`}
          />
          ...
          <ExternalLink className="relative w-5 h-5 text-slate-400 group-hover:text-sky-600 group-hover:translate-x-0.5 transition-all z-10" />
        </a>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {otherLinks.map((link, index) => (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group relative flex items-center gap-3 p-4 rounded-2xl bg-white border border-slate-200 overflow-hidden hover:border-sky-300 hover:shadow-md transition-all duration-500"
              data-aos="fade-up"
            ...
            >
              ...
              <div className="p-2 rounded-xl bg-slate-50 text-slate-700 border border-slate-100 group-hover:scale-110 transition-transform z-10">
              ...
              <ExternalLink className="w-4 h-4 text-slate-400 group-hover:text-sky-600 ml-auto group-hover:translate-x-0.5 transition-all z-10" />
            </a>
          ))}
        </div>
      </div>
